...
header = getExperimentHeader(PATIENT_id, exp_num); % load experiment info
...
% Time parameters
timefArgs.preStartTimeInSec = 0.6; % time before stimulus start
...
for freqs = 1:size(freq_ranges, 1)
    LFP_Analyzer_BP_Hilbert(header, electrodeTypeInd, channels, timefArgs, groupsTimes,...
